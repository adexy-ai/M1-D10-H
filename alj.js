...
function whoIsBigger(num1, num2) {
    if (num1 > num2) {
        ...
        //console.log(num2, "is the biggest numnber")
        return num2;
    }
}
...
function isTodayMyBirthday(day, month) {
    if (day === 23 && month === "March") {
        console.log("Yes! today is my birthday;")
        return true;
    } else {
        console.log("You are not quite righ, today is not my birthday;")
        return false;
    }
}
let birthdayGuessing = isTodayMyBirthday(23,"March")
// JS Arrays & Objects
...
/*function oldestMovie(movies) {
    let oldest = 0
    for (oldest = 0; oldest < oldestMovie.lenght; oldest++) {
